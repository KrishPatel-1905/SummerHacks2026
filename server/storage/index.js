...
import { GridFsStorage } from "./gridFsStorage.js";

const projectRoot = path.resolve(path.dirname(fileURLToPath(import.meta.url)), "../..");
export const uploadDirectory = path.resolve(process.env.UPLOAD_DIR || path.join(projectRoot, "uploads"));
export const uploadStorageType = process.env.UPLOAD_STORAGE === "local" ? "local" : "gridfs";
...
export const imageStorage = uploadStorageType === "local"
